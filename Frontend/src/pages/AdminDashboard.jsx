...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    if (!token) {
      navigate("https://civicconnect-a-public-grievance-85gb.onrender.com/admin-login");
      return;
    }
  ...
  const fetchAdminDetails = async () => {
    try {
      const res = await axios.get("https://civicconnect-1f9p.onrender.com/api/issues/profile", {
  ...
  const fetchDashboard = async () => {
    try {
      const res = await axios.get("https://civicconnect-1f9p.onrender.com/api/issues/dashboard-summary", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchSectors = async () => {
    try {
      const res = await axios.get("https://civicconnect-1f9p.onrender.com/api/issues/sectors", {
        headers: { Authorization: `Bearer ${token}` }
      });
      setSectors(res.data);
    } catch (err) {
  ...
  const fetchSectorRatings = async () => {
    try {
      const res = await axios.get("https://civicconnect-1f9p.onrender.com/api/feedback/sector-ratings", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const sendBroadcast = async () => {
    try {
      await axios.post(
        "https://civicconnect-1f9p.onrender.com/api/issues/broadcast", 
  ...
  const createSectorHead = async () => {
    try {
      await axios.post(
        "https://civicconnect-1f9p.onrender.com/api/sector-head/register",
        sectorHeadData,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const downloadCSV = async () => {
    try {
      const response = await axios.get("https://civicconnect-1f9p.onrender.com/api/issues/export-issues", {
        headers: { Authorization: `Bearer ${token}` },
        responseType: "blob", 
      });
