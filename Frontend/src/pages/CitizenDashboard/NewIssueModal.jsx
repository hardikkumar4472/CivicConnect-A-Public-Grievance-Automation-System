...
export default function NewIssueModal({ onSubmit, onClose }) {
  ...
  useEffect(() => {
    const fetchCitizenData = async () => {
      try {
        ...
        const response = await axios.get(`https://civicconnect-a-public-grievance-85gb.onrender.com/api/citizen/me`, {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onClose();
      navigate('https://civicconnect-a-public-grievance-85gb.onrender.com/citizen-dashboard');
