...
const IssueDetailsModal = ({ 
    ...
    const fetchCitizenDetails = async () => {
      try {
        ...
        const response = await axios.get(
          `https://civicconnect-1f9p.onrender.com/api/sector-head/sector-citizens`,
          { 
  ...
  try {
    ...
    const response = await axios.put(
      `https://civicconnect-1f9p.onrender.com/api/issues/${selectedIssue._id}/status`,
      { status: newStatus },
      {
        headers: {
  ...
  const handleAddComment = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://civicconnect-1f9p.onrender.com/api/issues/${selectedIssue._id}/comment`,
        { text: comment },
        {
          headers: {
            Authorization: `Bearer ${token}`,
