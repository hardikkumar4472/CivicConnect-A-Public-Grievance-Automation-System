...
const DashboardSummaryModal = ({ dashboardSummary: initialSummary, onClose }) => {
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      try {
        const { data } = await axios.get("https://civicconnect-1f9p.onrender.com/sector-head/dashboard-summary");
  ...
  const handleViewAllIssues = () => {
    onClose();
    navigate('https://civicconnect-1f9p.onrender.com/sectorHead-dashboard');
  };
