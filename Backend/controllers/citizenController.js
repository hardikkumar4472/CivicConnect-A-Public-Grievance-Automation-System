...
export const forgotPasswordCitizen = async (req, res) => {
  ...
  try {
    ...
    const resetLink = `https://civicconnect-a-public-grievance-85gb.onrender.com/reset-password/${token}`; 
    const htmlTemplate = `
<div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: auto; background: #000; color: #fff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.3);">
  <!-- Header with image -->
  <div style="background: #1a1a1a; text-align: center; padding: 20px 0;">
...
<div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: auto; background: #000; color: #fff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.3);">
  ...
  <div style="padding: 30px;">
    ...
    <!-- CTA Button -->
    <div style="text-align: center; margin-top: 30px;">
      <a href="https://civicconnect-a-public-grievance-85gb.onrender.com" style="background: linear-gradient(to right, #4d9de0, #6bb9f0); color: white; padding: 14px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block; font-size: 16px; transition: all 0.3s; box-shadow: 0 2px 10px rgba(77,157,224,0.3);">
